                ...
                <div class="ml-3 relative">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                            <span class="inline-flex rounded-md">
                                <button type="button" class="bg-gray-200 inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md hover:text-gray-100 hover:bg-primary focus:outline-none focus:bg-primary-50 active:bg-primary transition ease-in-out duration-150">
                                    {{ Auth::user()->name }}
