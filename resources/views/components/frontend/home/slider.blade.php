<div id="carouselExampleCaptions" class="relative" data-te-carousel-init data-te-carousel-slide>
    ...
    <div class="absolute bottom-0 left-0 right-0 z-[2] mx-[15%] mb-4 flex list-none justify-center p-0" data-te-carousel-indicators>
        <button type="button" data-te-target="#carouselExampleCaptions" data-te-slide-to="0" data-te-carousel-active class="mx-[3px] box-content h-[3px] w-[30px] flex-initial cursor-pointer border-0 border-y-[10px] border-solid border-transparent bg-white bg-clip-padding p-0 -indent-[461px] opacity-50 transition-opacity duration-[600ms] ease-[cubic-bezier(0.25,0.1,0.25,1.0)] motion-reduce:transition-none" aria-current="true" aria-label="Slide 1"></button>
        <button type="button" data-te-target="#carouselExampleCaptions" data-te-slide-to="1" class="mx-[3px] box-content h-[3px] w-[30px] flex-initial cursor-pointer border-0 border-y-[10px] border-solid border-transparent bg-white bg-clip-padding p-0 -indent-[461px] opacity-50 transition-opacity duration-[600ms] ease-[cubic-bezier(0.25,0.1,0.25,1.0)] motion-reduce:transition-none" aria-label="Slide 2"></button>
        <button type="button" data-te-target="#carouselExampleCaptions" data-te-slide-to="2" class="mx-[3px] box-content h-[3px] w-[30px] flex-initial cursor-pointer border-0 border-y-[10px] border-solid border-transparent bg-white bg-clip-padding p-0 -indent-[461px] opacity-50 transition-opacity duration-[600ms] ease-[cubic-bezier(0.25,0.1,0.25,1.0)] motion-reduce:transition-none" aria-label="Slide 3"></button>
    </div>
    ...
    <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
        ...
        <img src="images/navbar1.jpg" class="hidden lg:block w-full" alt="..." />
            <img src="images/navbar1sm.jpg" class="hidden md:block lg:hidden w-full" alt="..." />
            <img src="images/navbar1xs.jpg" class="block md:hidden w-full" alt="..." />
            <div class="absolute inset-x-[15%] bottom-10 lg:bottom-5 xl:bottom-10 2xl:bottom-16 py-5 text-left text-white">
        ...
        <img src="images/navbar3.jpg" class="hidden lg:block w-full" alt="..." />
            <img src="images/navbar3sm.jpg" class="hidden md:block lg:hidden w-full" alt="..." />
            <img src="images/navbar3xs.jpg" class="block md:hidden w-full" alt="..." />
            <div class="absolute inset-x-[15%] bottom-10 lg:bottom-5 xl:bottom-10 2xl:bottom-16 py-5 text-left text-white">
